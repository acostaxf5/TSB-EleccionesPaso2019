 ...
 */
public class JavaOAHashTable<K, V> implements Map<K, V>, Cloneable, Serializable {
     ...
     */    
    public JavaOAHashTable(int initial_capacity)
    {
     ...
     */
    public JavaOAHashTable(int initial_capacity, float load_factor)
    {
     ...
     */     
    public JavaOAHashTable(Map<? extends K,? extends V> t)
    {
        this(11, 0.5f);
        this.putAll(t);
    }
    ...
    {
        if (key == null) { throw new NullPointerException("containsKey(): Parámetro nulo."); }
    ...
    public V remove(Object key) 
    {
        ...
        int ik = this.h(key.hashCode());
        int index = this.search_for_index((K) key, ik);
        V old = null;
        if (index != -1){
            old = this.get(key);
            this.table[index] = new Entry<K, V>(null, null, TOMBSTONE);
            this.count--;
            this.modCount++;
        }
        return old;
    ...
    public void putAll(Map<? extends K, ? extends V> m) 
    {
        ...
        {
            if (e.getKey() != null && e.getValue() != null) { put(e.getKey(), e.getValue()); }
        }
    }
    ...
    public void clear() 
    {
        ...
        for(int i = 0; i < this.table.length; i++){
            this.table[i] = new Entry<K, V>(null, null, OPEN);
        }
     ...
     * addAll() (si se las invoca, se lanzará una UnsuportedOperationException).
     *
     * @return un conjunto (un Set) a modo de vista de todos los objetos mapeados en la tabla.
     */
    @Override
    ...
    {
        // HACER...
        JavaOAHashTable<K, V> t = (JavaOAHashTable<K, V>)super.clone();
        t.table = new Object[this.table.length];

        System.arraycopy(this.table, 0, t.table, 0, t.table.length);
    ...
    {
        if(!(obj instanceof JavaOAHashTable)) { return false; }
        
        JavaOAHashTable<K, V> t = (JavaOAHashTable<K, V>) obj;
    ...
    public boolean contains(Object value)
    {
        ...
        for (Object object : this.table) {
            Map.Entry<K, V> newEntry = (Map.Entry<K, V>) object;
            if (value.equals(newEntry.getValue())) {
                return true;
            }
        }
    ...
    private class Entry<K, V> implements Map.Entry<K, V>, Serializable {
        ...
        public String toString()
        {
            ...
            if (this.key != null && this.value != null) {
                cad += "(" + this.key.toString() + ", " + this.value.toString() + ")";
            }
            return cad;
        }
    }
    ...
    private class KeySet extends AbstractSet<K> 
    {
        ...
        public int size() 
        {
            return JavaOAHashTable.this.count;
        }
        
        @Override
        public boolean contains(Object o) { return JavaOAHashTable.this.containsKey(o); }
        
        @Override
        public boolean remove(Object o) { return (JavaOAHashTable.this.remove(o) != null); }
        
        @Override
        public void clear() 
        {
            JavaOAHashTable.this.clear();
        }
        ...
        private class KeySetIterator implements Iterator<K>
        {
            ...
            public KeySetIterator()
            {
                ...
                this.next_ok = false;
                this.expected_modCount = JavaOAHashTable.this.modCount;
            }
            ...
            {
                // HACER...
                if (JavaOAHashTable.this.isEmpty()) { return false; }
                if (this.current_entry >= JavaOAHashTable.this.table.length - 1) { return false; }
            ...
            public K next() 
            {
                ...
                if(JavaOAHashTable.this.modCount != expected_modCount)
                {    
                ...
                this.current_entry++;
                Map.Entry<K, V> nextElement = (Map.Entry<K, V>) JavaOAHashTable.this.table[this.current_entry];
            ...
            public void remove() 
            {
                ...
                Map.Entry<K, V> removeElement = (Map.Entry<K, V>) JavaOAHashTable.this.table[this.current_entry];
                JavaOAHashTable.this.remove(removeElement.getKey());
                this.current_entry--;
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> 
    {
        ...
        public boolean contains(Object o) 
        {
            ...
            Map.Entry<K, V> paramEntry = (Map.Entry<K, V>) o;
            for (Object object : JavaOAHashTable.this.table) {
                Map.Entry<K, V> objectEntry = (Map.Entry<K, V>) object;

                if (objectEntry.getKey().equals(paramEntry.getKey())) {
                    if (objectEntry.getValue().equals(paramEntry.getValue())) {
                        return true;
                    }
                }
            }
        ...
        public boolean remove(Object o) 
        {
            ...
            V old = JavaOAHashTable.this.remove(entry.getKey());
        ...
        private class EntrySetIterator implements Iterator<Map.Entry<K, V>>
        {
            ...
            public Map.Entry<K, V> next() 
            {
                ...
                return (Map.Entry<K, V>) JavaOAHashTable.this.table[this.current_entry];
            }
    ...
    private class ValueCollection extends AbstractCollection<V> 
    {
        ...
        public boolean contains(Object o) 
        {
            return JavaOAHashTable.this.containsValue(o);
        }
        ...
        private class ValueCollectionIterator implements Iterator<V>
        {
            ...
            public void remove() 
            {
                ...
                Map.Entry<K, V> removeEntry = (Map.Entry<K, V>) JavaOAHashTable.this.table[this.current_entry];
                JavaOAHashTable.this.remove(removeEntry.getKey());
                this.current_entry--;
